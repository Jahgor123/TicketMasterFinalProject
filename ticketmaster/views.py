...
def index(request):
    ...
    if request.method == 'POST':
        ...
        number_of_events = request.POST['pick-me']
        gender = request.POST['searchbar']

        print(number_of_events)
        print(gender)

        # # Check if either number_of_users or gender is empty
        # if not number_of_events or not gender:
        ...
        # random_female_users = get_tickets(number_of_events, gender, nationality='us')
        #
...
def get_tickets(number_of_events):
    try:
        # searchBar Id
        #  searchTerm = update
        # searchstate Id
